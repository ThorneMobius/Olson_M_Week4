...
def draw_jack(t, x, y, radius):
    ...
    mouth_height = y +.45*radius
    eye_size = radius / 4
    draw_eye(t, x -(.500*radius), eye_height, eye_size)  # Left eye
    draw_eye(t, x + (.500*radius), eye_height, eye_size)  # Right eye
    draw_mouth(t, x-.500*radius,mouth_height , radius)  # Mouth
...
# Draw three jack-o-lantern
#draw_pumpkin(t, 150, 20, 75)
#draw_eye(t, 190, 110, 30)  # Left eye
#draw_eye(t, 110, 110, 30)  # Right eye
#draw_mouth(t, 130, 75, 80)  # Mouth
draw_jack(t, 150, 20, 75)
draw_jack(t, 0, 20, 75)
draw_jack(t, -150, 20, 75)
# Draw the night sky
draw_sky(t, 30)
